...
const modalStyles = {
    ...
    headerSub: {
        fontSize: '14px',         // ← 12 dan 14 ga
        color: '#6B7280',
        margin: 0,
        marginTop: '4px',
    },
    progressTrack: {
        height: '5px',            // ← 3 dan 5 ga
        background: '#F3F4F6',
        borderRadius: '3px',
        overflow: 'hidden',
        marginBottom: '20px',
    ...
    adImage: {
        width: '100%',
        height: '220px',          // ← 140 dan 220 ga
        objectFit: 'cover',
        display: 'block',
    },
    adBody: {
        padding: '18px',          // ← 12 dan 18 ga
    },
    storeRow: {
        display: 'flex',
        alignItems: 'center',
    ...
    storeLogo: {
        width: '26px',            // ← 20 dan 26 ga
        height: '26px',
        borderRadius: '6px',
        objectFit: 'cover',
    },
    storeName: {
        fontSize: '13px',         // ← 12 dan 13 ga
        color: '#6B7280',
        fontWeight: '500',
    },
    partnerBadge: {
    ...
    adBtn: {
        width: '100%',
        padding: '14px',          // ← 8 dan 14 ga
        background: '#1D9E75',    // ← to'q yashil
        color: '#fff',            // ← oq matn
        border: 'none',
        borderRadius: '12px',
        fontSize: '15px',         // ← 13 dan 15 ga
        fontWeight: '700',
        cursor: 'pointer',
        textAlign: 'center',
